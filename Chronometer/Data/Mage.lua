...
function Chronometer:MageSetup()
	...
	self:AddTimer(self.SPELL, BS["Counterspell"],  10, 1,0,0, { ea={[L["Counterspell - Silenced"]]=1} })
	...
	self:AddTimer(self.SPELL, BS["Frostbolt"],      9, 1,0,0, { d={rt={5,6,6,7,7,8,8}, tn=BS["Permafrost"], tb=1}, ea={[L["Winter's Chill"]]=2} })
	...
	self:AddTimer(self.EVENT, L["Counterspell - Silenced"], 4, 1,0,0, { cr="GREEN", xn=BS["Counterspell"] })
